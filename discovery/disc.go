...
// isHostAvailable performs multiple checks to verify host availability
...
// pingHost performs an ICMP ping to check host availability
...
// tcpPortCheck attempts to connect to common ports
func (ns *NetworkScanner) tcpPortCheck(ip string) bool {
